...
$(document).ready(function () {
    ...
    $('#main .mainleft .liulan .liuleft').hover(
        function () {
            $('#main .mainleft .liulan .liuleft .lefttu').css({'background-position': '1px -6px', 'background-image': 'url(images/15.png)'});
            $(this).css('background-color', '#f3f3f3');
        },

        function () {
            $('#main .mainleft .liulan .liuleft .lefttu').css({'background-position': '-83px -51px', 'background-image': 'url(images/16.png)'});
